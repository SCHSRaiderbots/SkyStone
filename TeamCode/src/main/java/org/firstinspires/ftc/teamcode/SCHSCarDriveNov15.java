...
public class SCHSCarDriveNov15 extends OpMode {
    ...
    private void powerClip(double power, int minEncoderPos, int maxEncoderPos, DcMotor desiredMotor) {
        ...
        if (desiredMotor.getCurrentPosition() < maxEncoderPos -20
        /*&&  desiredMotor.getCurrentPosition() >= minEncoderPos + 20*/) {

            desiredMotor.setPower(power);

        } else if (desiredMotor.getCurrentPosition() < maxEncoderPos) {
    ...
    private void hooks() {
        ...
        if (hooksEngaged == false) {
            ...
            leftHook.setPosition(155);
            rightHook.setPosition(155);
    ...
    private void elevatorMovement() {
        ...
        if (leftTriggerInput(gamepad2.right_trigger, gamepad2.left_trigger)) {
            ...
            powerClip(armPower, 0, maxElevatorPos, elevatorMotor);
